...
<form name="chngpwd" method="post" onSubmit="return valid();">        
 ...
 <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
   ...
   <input class="form-control white_bg" id="currentpassword" name="currentpassword"  type="password" required>
                          </div>
                        </fieldset>
  ...
  <input class="form-control white_bg" id="newpassword" type="password" name="newpassword"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter
