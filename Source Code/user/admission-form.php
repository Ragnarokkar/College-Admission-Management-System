...
if(isset($_POST['submit']))
  {
    ...
    $coursename=$_POST['coursename'];
	 $qt=mysqli_query($con,"select ID from tblcourse where coursename='$coursename'");
	$cr= mysqli_fetch_array($qt);
...
$userpic=md5($upic).$extension;
    ...
    $query=mysqli_query($con,"insert into tbladmapplications(UserId,CourseID,CourseApplied,FatherName,MotherName,DOB,Nationality,Gender,Category,CorrespondenceAdd,PermanentAdd,EEName,EERank,SecondaryBoard,SecondaryBoardyop,SecondaryBoardper,SecondaryBoardstream,SSecondaryBoard,SSecondaryBoardyop,SSecondaryBoardper,SSecondaryBoardstream,GraUni,GraUniyop,GraUnidper,GraUnistream,PGUni,PGUniyop,PGUniper,PGUnistream,Signature,UserPic) 
	value('$uid','$cid','$coursename','$fathername','$mothername','$dob','$nationality','$gender','$category','$coradd','$peradd','$eename','$eerank','$secboard','$secyop','$secper','$secstream','$ssecboard','$ssecyop','$ssecper','$ssecstream','$grauni','$grayop','$graper','$grastream','$pguni','$pgyop','$pgper','$pgstream','$sign','$userpic')");
    if ($query) {
...
<tr>
  <th><?php echo $row['EEName']?> Rank</th>
  <td><?php echo $row['EERank'];?></td>
</tr>
  ...
  <h5>Course Applied                   </h5>
   ...
   <select name='coursename' id="coursename" class="form-control white_bg">
     <option value="">Course Applied</option>
      <?php $query=mysqli_query($con,"select * from tblcourse where emptyseats > 0" );
              while($row=mysqli_fetch_array($query))
              {
 ...
 <fieldset>	
  <h5>DOB                   </h5>
   ...
   <input class="form-control white_bg" id="dob" name="dob"  type="date" required>
          <small class="text-muted">DOB Must be in this format (DD-MM-YYYY)</small>
    </div>
...
<div class="row">
  <div class="col-xl-12 col-lg-12">
    <h5>Category : 
   <input  id="category" name="category"  type="radio" value="General" required> General &nbsp;&nbsp;<input  id="category" name="category"  type="radio" value="OBC" required> OBC &nbsp;&nbsp;<input  id="category" name="category" value="SC/ST" type="radio" required> SC/ST&nbsp;&nbsp;<input  id="category" name="category"  type="radio" value="Other" required> Other </h5>
  </div>
</div>
...
<div class="col-xl-6 col-lg-12">
 <fieldset>
  <h5>Entrance Exam                   </h5>
   <div class="form-group">
   <select name='eename' id="eename" class="form-control white_bg">
...
<div class="col-xl-6 col-lg-12">
 <fieldset>
  <h5>Rank                   </h5>
   <div class="form-group">
   <input class="form-control white_bg" id="eerank" name="eerank"  type="text" required>
    </div>
</fieldset>               
</div>
...
<div class="col-xl-12 col-lg-12"><h4 class="card-title"><b>Declartaion</b></h4> <hr />
</div>
</div>
 <div class="row">
<div class="col-xl-12 col-lg-12">
