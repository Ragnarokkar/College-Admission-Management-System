...
if(isset($_POST['submit']))
  {
	...
	mysqli_query($con, "update  tblcourses inner join tbladmapplications on tblcourses.ID = tbladmapplications.CourseID set tblcourses.EmptySeats=tblcourses.EmptySeats - 1 where tbladmapplications.ID='$cid'");
	}
