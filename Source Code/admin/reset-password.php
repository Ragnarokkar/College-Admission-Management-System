...
data-open="click" data-menu="vertical-menu" data-col="1-column">
    ...
    echo $msg;
                    ...
                    <form class="form-horizontal"  name="resetpassword"  method="post" onsubmit="return checkpass();">
                          ...
                          <fieldset class="form-group position-relative has-icon-left">
                            ...
                            placeholder="Enter New Password"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter
  ...
  <footer class="footer fixed-bottom footer-dark navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block"><a class="text-bold-800 grey darken-2" > </a>Group 7 Student Admission Management System  </span>
