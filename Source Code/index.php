...
<body>
  ...
  <nav class="navbar navbar-light bg-light static-top">
    <div class="container">
      <a class="navbar-brand" href="index.php">Student Admission Management System</a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-12 mx-auto">
          <h1 class="mb-5">Welcome to Student Admission Management System </h1>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 h-100 text-center text-lg-left my-auto">
          ...
          <p class="text-muted small mb-4 mb-lg-0">Group 7 student Admission Management System</p>
        </div>
